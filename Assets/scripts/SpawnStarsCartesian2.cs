...
public class SpawnStarsCartesian2 : MonoBehaviour {
        ...
        void Start ()
	{
        ...
        for(int i = 1; i < data.Length; i++)
        {
            ...
            tempStar.transform.localPosition = transform.localPosition + transform.TransformPoint(new Vector3(x,y,z));
            tempStar.transform.localPosition *= distanceExagerationMultiplier;
            //star diameter
            if (!SetDiameter)
            {
